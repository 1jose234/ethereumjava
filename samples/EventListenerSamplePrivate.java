 ...
 */
public class EventListenerSamplePrivate extends ConfConexionPrivada {
    ...
    private void deployContractAndTest() throws Exception {
        ethereum.addListener(new EthereumListenerAdapter() {
            ...
            public void onBlock(Block block, List<TransactionReceipt> receipts) {
                EventListenerSamplePrivate.this.onBlock(block, receipts);
            }
        });
    ...
    public static void main(String[] args) throws Exception {
        ...
        class Config extends TestNetConfig{
            ...
            public ConfConexionPrivada sampleBean() {
                return new EventListenerSamplePrivate();
            }
        }
