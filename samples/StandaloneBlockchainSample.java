...
public class StandaloneBlockchainSample {
    ...
    public static void main(String[] args) throws Exception {
    	 System.out.println("VAL=>"+Hex.decode("3ec771c31cac8c0dba77a69e503765701d3c2bb62435888d4ffa38fed60c445c"));
        ...
        bc.createBlock();
        System.out.println("NetworkId: "+ SystemProperties.getDefault().networkId()+" enode://" + Hex.toHexString(SystemProperties.getDefault().nodeId()) + "@" + SystemProperties.getDefault().externalIp() + ":" + SystemProperties.getDefault().listenPort());        
        ...
        System.out.println("Valor de variable"+calc.callConstFunction("result")[0]);
